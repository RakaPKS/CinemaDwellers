...
namespace Offline.Runners
{
    public class ExperimentRunner
    {
        ...
        private string InstancesFolder = null;
        private string ConfigsFolder = null;
        ...
        {
            Options = options;
            InstancesFolder = options.ExperimentsConfig.InstancesFolder;
            ConfigsFolder = options.ExperimentsConfig.ConfigsFolder;
